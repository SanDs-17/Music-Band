                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {profile.genres?.map(g => (
                      <Badge key={g.id} variant="secondary" className="text-[10px] py-1 font-semibold text-white">
                        {g.name}
                      </Badge>
                    ))}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {profile.languages?.map(l => (
                      <Badge key={l.id} variant="outline" className="text-[10px] py-1 font-semibold text-white">
                        {l.name}
                      </Badge>
                    ))}
            ...
            <CardContent className="p-5 space-y-4">
              ...
              <div className="space-y-3.5 divide-y divide-border/40">
                ...
                <div className="flex justify-between items-center text-xs pt-3.5">
                  ...
                  <span className="font-bold text-white">{profile.travel_radius} km limit</span>
                </div>
                <div className="flex justify-between items-center text-xs pt-3.5">
                  ...
                  <span className="font-bold text-white">{formatCurrency(profile.travel_charges)} / extra km</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-5 space-y-4">
                ...
                <div className="flex flex-wrap gap-3">
                  {profile.social_links?.instagram && (
                    <a href={profile.social_links.instagram} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-bg-elevated border border-border/80 text-pink-400 hover:text-white rounded-xl transition-colors">
                      <Instagram className="h-4.5 w-4.5" />
                    </a>
                  )}
                  {profile.social_links?.facebook && (
                    <a href={profile.social_links.facebook} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-bg-elevated border border-border/80 text-blue-400 hover:text-white rounded-xl transition-colors">
                      <Facebook className="h-4.5 w-4.5" />
                    </a>
                  )}
                  {profile.social_links?.twitter && (
                    <a href={profile.social_links.twitter} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-bg-elevated border border-border/80 text-sky-400 hover:text-white rounded-xl transition-colors">
                      <Twitter className="h-4.5 w-4.5" />
                    </a>
                  )}
                  {profile.social_links?.website && (
                    <a href={profile.social_links.website} target="_blank" rel="noopener noreferrer" className="p-2.5 bg-bg-elevated border border-border/80 text-purple-400 hover:text-white rounded-xl transition-colors">
