        ...
        <Card className="bg-bg-card/45 backdrop-blur-md border border-border/80 rounded-2xl shadow-xl group hover:border-primary/50 transition-colors">
          <Link href="/artists">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-text-primary">Find Artists</p>
                <p className="text-xs text-text-secondary mt-0.5">
          ...
          <CardContent className="p-5 space-y-3">
            {[
              ...
              <Link
                key={item.step}
                href={item.href}
                className="flex items-center gap-3 text-sm hover:text-text-primary transition-colors group"
              >
