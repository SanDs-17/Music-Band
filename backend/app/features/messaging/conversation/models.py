...
class Conversation(BaseModel):
    ...
    pinned_message_id = Column(
        ...
        ForeignKey(
            ...
            ondelete="SET NULL",
            use_alter=True,
            name="fk_conversations_pinned_message_id",
        ),
        nullable=True,
        default=None,
        index=True,
    ...
    client = relationship(
        "User", foreign_keys=[client_id], backref="client_conversations"
    )
    band = relationship("User", foreign_keys=[band_id], backref="band_conversations")
    venue_owner = relationship(
        "User", foreign_keys=[venue_owner_id], backref="venue_owner_conversations"
    )
